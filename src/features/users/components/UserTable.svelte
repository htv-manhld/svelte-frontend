					...
					<tr class="transition-colors hover:bg-gray-50">
						...
						<td class="px-6 py-4">
							<div class="flex gap-2">
								<button
									onclick={() => onEdit(user)}
									class="flex items-center gap-1.5 rounded-lg bg-blue-50 px-3 py-1.5 text-sm font-medium text-blue-600 hover:bg-blue-100"
								>
									<svg
								...
								<button
									...
									class="flex items-center gap-1.5 rounded-lg bg-red-50 px-3 py-1.5 text-sm font-medium text-red-600 hover:bg-red-100"
								>
									<svg
										xmlns="http://www.w3.org/2000/svg"
										fill="none"
